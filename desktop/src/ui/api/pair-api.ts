...
export interface IFabricApi {
    ...
    describeLogicalDevice(): Promise<FabricLogicalDeviceDescribe>
    ...
    seedLogicalDevicePage(request: FabricLogicalDeviceSeedRequest): Promise<{ pageId: string; bytes: number; digest: string }>
    ...
    recoverTraining(jobId: string, nodes: FabricTrainingNode[], rendezvousEndpoint: string): Promise<FabricTrainingExecution[]>
    stopTraining(jobId: string): Promise<{ stopped: boolean }>
}
...
export function createPairApi(transport: ServiceTransport): IPairApi {
    return {
        ...
        fabric: {
            ...
            describeLogicalDevice: () => transport.invoke('fabric:logical-device-describe'),
            ...
            seedLogicalDevicePage: request => transport.invoke('fabric:logical-device-seed', request),
            ...
            recoverTraining: (jobId, nodes, rendezvousEndpoint) => transport.invoke('fabric:training-recover', { jobId, nodes, rendezvousEndpoint }),
            stopTraining: jobId => transport.invoke('fabric:training-stop', { jobId })
        },
        workloads: {
